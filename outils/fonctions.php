...
function afficher_contacts()
	...
	while($ligne=mysqli_fetch_object($resultat))
		...
		$tab_resultat.="<tr>\n";
			...
			$tab_resultat.="<td><a href=\"index.php?action=supprimer_contact&id_contact=".$ligne->id_contact."\"><span class=\"dashicons dashicons-trash\"></span></a></td>\n";
		$tab_resultat.="</tr>\n";
		}
	$tab_resultat.="</table>\n";
...
function afficher_comptes()
	...
	$connexion=connexion();
	//selectionne tous les champs de la table contacts
	//en triant par ordre de création croissant
	...
	while($ligne=mysqli_fetch_object($resultat))
		{
		$tab_resultat.="<tr>\n";
			$tab_resultat.="<td>".stripslashes($ligne->nom_compte)."</td>\n";
			...
			$tab_resultat.="<td><a href=\"index.php?action=supprimer_compte&id_compte=".$ligne->id_compte."\"><span class=\"dashicons dashicons-trash\"></span></a>\n";
			$tab_resultat.="&nbsp;|&nbsp";
			$tab_resultat.="<a href=\"index.php?action=modifier_compte&id_compte=".$ligne->id_compte."\"><span class=\"dashicons dashicons-edit\"></span></a>\n";
